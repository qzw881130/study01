//https://blog.csdn.net/fsf_snail/article/details/77875527
...
export default class FlatListBasic extends PureComponent {
    ...
    _onPressItem = (id: string) => {
        ...
        console.log(JSON.stringify(id), this.state.sourceData[id]);
        this.refs.toast.show(this.state.sourceData[id]['title']);
    ...
    _onEndReached = () => {
        ...
        for (let i = 20; i < 30; i ++) {
            let obj = {
                id: i
                ,title: i + '生了只小柯基'+(new Date()).toTimeString()
            };
